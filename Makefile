...
SRC =	create_button/retour_defeat.c \
		...
		create_button/btn_sauvegarder_in_MP.c \
		create_button/btn_option_in_MP.c \
		create_button/btn_menu_prin_in_MP.c \
		create_button/btn_quitter_in_MP.c \
		collider_button/collider_btn_in_menu_pause.c \
		create_button/btn_reprendre_in_MP.c \
