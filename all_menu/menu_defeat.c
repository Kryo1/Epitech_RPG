...
int create_game_over(glb_t *global)
{
    ...
    sfSprite_setTexture(global->game_over.sprite, global->game_over.texture, sfTrue);
    sfSprite_setPosition(global->game_over.sprite, global->game_over.pos);
    return (0);
}
...
void draw_for_the_menu_defeat(glb_t *global)
{
    ...
    sfRenderWindow_drawSprite(global->wind.window, global->game_over.sprite, NULL);
    sfRenderWindow_drawSprite(global->wind.window, global->retour_defeat.sprite, NULL);
    sfRenderWindow_drawSprite(global->wind.window,
